<div id="search" class="s-search">
    <div id="search-list" class="hide-type-list">
        <div class="s-type">
                <label class="s-item" for="type-search"><?php _e('搜索','i_theme') ?></label>
                <label class="s-item" for="type-br"><?php _e('工具','i_theme') ?></label>
                <label class="s-item" for="type-zhihu"><?php _e('社区','i_theme') ?></label>
                <label class="s-item" for="type-taobao1"><?php _e('生活','i_theme') ?></label>
                <label class="s-item" for="type-zhaopin"><?php _e('求职','i_theme') ?></label>
        </div>
...
<script type="text/javascript">
    $(function () {
        var currentIndex = $('.s-current').index();
        $('.s-item').eq(currentIndex).addClass('active');
